 ...
 * @author soporte
 */
public class listarCotizacion extends javax.swing.JFrame {

    ArrayList<Cotizacion> lista = new ArrayList();
    confirmarCotizacion cc;
    String rutaArchivos = "";
    ...
    public listarCotizacion(confirmarCotizacion cc) {
        initComponents();
        llenarTabla();
        this.cc = cc;
        changeIcon();
    ...
    private void initComponents() {
        ...
        setTitle("Listado de Cotizaciones Emitidas - SGDS");
        setUndecorated(true);
        ...
        jLabel1.setText("Cotizaciones Emitidas");
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "# Cot", "Cliente", "Realizado Por:", "Fecha"
            }
        ) {
        ...
        clienteTxt.setPlaceholder("Ingresa el Nombre del Cliente a buscar...");
        ...
        jLabel5.setText("Archivos Excel Subidos con la Cotización");
        ...
        rSButtonRoundEffectIcon1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        jLabel6.setText("Presione Click ( 02 ) dos Veces sobre la Tabla para seleccionar el Presupuesto  deseado");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 399, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        if (evt.getClickCount() == 1
                ...
                && !tabla.getValueAt(tabla.getSelectedRow(), 2).toString().equals("SIN COTIZACIONES PENDIENTES")) {

            int idCot = Integer.parseInt(tabla.getValueAt(tabla.getSelectedRow(), 0).toString());
            idSolicitud = new Cotizacion().getIdSolicitud(idCot);
            buscarArchivos(idSolicitud);
        } else if (evt.getClickCount() == 2 && !tabla.getValueAt(tabla.getSelectedRow(), 2).toString().equals("SIN COTIZACIONES PENDIENTES")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listarCotizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listarCotizacion().setVisible(true);
            }
        });
    }
    ...
    public void llenarTabla() {
        ...
        lista = (ArrayList) new Cotizacion().listarEstado("Cot. Creada - Esperando por Cliente").clone();
        ...
        if (lista.size() > 0) {
            ...
            for (int i = 0; i < lista.size(); i++) {
                modelo.addRow(new Object[]{
                    ...
                    lista.get(i).getPresupuesto().getCliente(),
                    lista.get(i).getResponsable(),
                    lista.get(i).getFecha()
                });
            }
        } else {
            modelo.addRow(new Object[]{"", "", "SIN COTIZACIONES PENDIENTES", ""});
        }
    ...
    private void extraerDatosSolicitud() {
        ...
        cc.setSolicitud(new Solicitud(idSolicitud));
        cc.setCotizacion(new Cotizacion().buscarID(idCot));

        cc.idCotizacion.setText(idCot + "");
        cc.setDatos();        
        cc.setExtendedState(NORMAL);
        this.dispose();
    }

    private void listarTabla(String text) {
        lista = new ArrayList();
        lista = (ArrayList) new Cotizacion().listarxNombreyEstado(text, "Cot. Creada - Esperando por Cliente").clone();
    ...
    private void buscarArchivos(int idSolicitud) {
        ...
        rutaArchivos = "\\\\atenea\\SGDS\\Data\\1. Clientes\\" + cliente + "\\1. Solicitudes\\" + idSolicitud + "\\2.Cotizacion\\";
    ...
    public void vaciarTablaArchivos() {
        DefaultTableModel modelo = (DefaultTableModel) tablaArchivo.getModel();
        modelo.setRowCount(0);
    }
