 ...
 * @author soporte
 */
public class listarCotsinCerrar extends javax.swing.JFrame {

    Cotizacion c;
    newCierre nc;
    public listarCotsinCerrar() {
        initComponents();
        llenarTabla();   
        changeIcon();
    }
     public listarCotsinCerrar(newCierre nc) {
        initComponents();
        llenarTabla(); 
         setLocation(10, 10);
        this.nc=nc;
    ...
    private void initComponents() {
        ...
        if (tablaArchivo.getColumnModel().getColumnCount() > 0) {
            tablaArchivo.getColumnModel().getColumn(0).setMinWidth(80);
            tablaArchivo.getColumnModel().getColumn(0).setPreferredWidth(80);
            tablaArchivo.getColumnModel().getColumn(0).setMaxWidth(80);
            ...
            tablaArchivo.getColumnModel().getColumn(3).setMinWidth(100);
            tablaArchivo.getColumnModel().getColumn(3).setPreferredWidth(100);
            tablaArchivo.getColumnModel().getColumn(3).setMaxWidth(100);
        }

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("Busque la OT que desea Cerrar:");
        ...
        jLabel4.setText("Listado de OTs sin cerrar");
            ...
            .addGroup(panelCentralLayout.createSequentialGroup()
                ...
                .addGroup(panelCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelCentralLayout.createSequentialGroup()
                        ...
                        .addComponent(texto, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelCentralLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelCentralLayout.createSequentialGroup()
                ...
                .addGroup(panelCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(texto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listarCotsinCerrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listarCotsinCerrar().setVisible(true);
            }
        });
    }
    ...
    private void llenarTabla() {
       ArrayList<Cotizacion> lista = (ArrayList<Cotizacion>) new Cotizacion().listarxEsperandoCierre().clone();
       ...
       if(modelo.getRowCount()==0){
           modelo.addRow(new Object[]{
           "","","No hay Cots. por Ingresar Cierre",""
           });
           limpiarCampos();
       }
    }
private void llenarTabla(String dato) {
       ArrayList<Cotizacion> lista = (ArrayList<Cotizacion>) new Cotizacion().listarxEsperandoCierreDATO(dato).clone();
       DefaultTableModel modelo = (DefaultTableModel) tablaArchivo.getModel();
       modelo.setRowCount(0);
       for(Cotizacion c :lista){
           modelo.addRow(new Object[]{
    ...
    private boolean validarSeleccion() {
        ...
        if(tablaArchivo.getSelectedRow() <0){
            ...
            if((tablaArchivo.getValueAt(tablaArchivo.getSelectedRow(), 0).toString()).equals("No hay Cots. por Ingresar Cierre")){
