 ...
 * @author soporte
 */
public class aceptarPlanozzz extends javax.swing.JFrame {
    listarCotAprobadas lca = new listarCotAprobadas();
    Cotizacion c;
    ...
    Main m;
    public aceptarPlanozzz() {
        initComponents();
        changeIcon();
        panelContenido.setVisible(false);
        
    }
 public aceptarPlanozzz(Main m) {
        initComponents();
        this.m=m;
        changeIcon();
        panelContenido.setVisible(false);
    ...
    private void initComponents() {
        ...
        rSButtonIconShadow2.setToolTipText("Obtener Planos de Otra Cotización");
        rSButtonIconShadow2.setBackgroundHover(new java.awt.Color(0, 153, 153));
        rSButtonIconShadow2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        rSButtonIconShadow2.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.IMPORT_EXPORT);
        rSButtonIconShadow2.setThemeTooltip(necesario.Global.THEMETOOLTIP.LIGHT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aceptarPlanozzz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new aceptarPlanozzz().setVisible(true);
            }
        });
    }
    ...
    private void actualizarRegistros() {
        String vendedor = (Main.getVendedor()).equals("vacio") ? "Franklin Parra" : Main.getVendedor();
        int idPresupuesto = c.getIdPresupuesto();
        int idSolicitud = c.getIdSolicitud(c.getID());

        Presupuesto p = new Presupuesto(idPresupuesto);
        p.setEstado(estado);
        p.update();

        s = new Solicitud(idSolicitud);
        s.setEstado(estado);        
        s.update();
    ...
    private void esperar(int i) {
        try {
            ...
            Logger.getLogger(aceptarPlanozzz.class.getName()).log(Level.SEVERE, null, ex);
