 ...
 * @author soporte
 */
public class panelBuscarComunicacionesFechas extends javax.swing.JPanel {
    ...
    public panelBuscarComunicacionesFechas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Buscar Comunicaciones por Fechas");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel8)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panelResultados, javax.swing.GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void exportar() {
        try {
            new exportarExcel().Exportar(tabla, "Reporte por Fechas");
    ...
    private String generateWhereSQL() {
        ...
        if (validarFechas()) {
            sqlWhere = " where  str_to_date(fecha, '%d/%m/%Y') >= str_to_date('"+fecha1x+"', '%d/%m/%Y') "
                    + " and "
                    + " str_to_date(fecha, '%d/%m/%Y') <= str_to_date('"+fecha2x+"', '%d/%m/%Y')";
        }
                    ...
                    if (rs.getString("tipo").equalsIgnoreCase("Cotización")) {
                        ...
                        if (rs.getString("tipo").equalsIgnoreCase("Despacho")) {
                            ...
                            if (rs.getString("tipo").equalsIgnoreCase("Cliente")) {
                                Cliente d = new Cliente().buscarId(rs.getInt("idCliente"));
                                cliente = d.getNombre1();
                                numCot = "-";
                            }
                        }
                    }
