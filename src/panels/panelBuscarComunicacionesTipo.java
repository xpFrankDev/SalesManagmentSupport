 ...
 * @author soporte
 */
public class panelBuscarComunicacionesTipo extends javax.swing.JPanel {
    ...
    public panelBuscarComunicacionesTipo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tipoCombo = new RSMaterialComponent.RSComboBox();
        ...
        jLabel1.setText("Buscar Comunicaciones por Tipo de Comunicación");
        ...
        jLabel6.setText("Tipo de Comunicación");

        tipoCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todos", "Correo Electronico", "LLamada Telefónica", "Whatsapp" }));
        tipoCombo.setColorArrow(new java.awt.Color(161, 54, 48));
        tipoCombo.setColorBorde(new java.awt.Color(161, 54, 48));
        tipoCombo.setColorBoton(new java.awt.Color(153, 153, 153));
        tipoCombo.setColorFondo(new java.awt.Color(161, 54, 48));
        tipoCombo.setColorSeleccion(new java.awt.Color(161, 54, 48));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tipoCombo, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(33, 33, 33)
                .addComponent(panelResultados, javax.swing.GroupLayout.PREFERRED_SIZE, 348, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private RSMaterialComponent.RSComboBox tipoCombo;
    // End of variables declaration//GEN-END:variables

    private void actualizarDatos() {
        panelResultados.setVisible(false);
        //llenarTipoComunicacion();

    }
private void exportar(){
    exportarExcel ee = new exportarExcel();
            try {
                ee.Exportar(tabla, "Reporte por Tipo Com.");
                new Thread(this::ocultarCarga).start();
            } catch (IOException ex) {
                Logger.getLogger(panelBuscarComunicacionesTipo.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private String generateWhereSQL() {
        ...
        if (tipoCombo.getSelectedItem().equals("Todos")) {
            if (swtichFecha.isSelected()) {
            ...
            String vendedor = tipoCombo.getSelectedItem().toString();
            if (swtichFecha.isSelected()) {
                if (validarFechas() == true) {
                    if (fecha1x.equals(fecha2x)) {
                        sqlWhere = "where vendedor='" + vendedor + "' and fecha = '" + fecha1x + "'";
                    } else {
                        sqlWhere = "where tipoComunicacion='" + vendedor + "' and  fecha between '" + fecha1x + "" + "' and '" + fecha2x + "' ";
                    }
                ...
                sqlWhere = "where tipoComunicacion='" + vendedor + "'";
            }
        }
    ...
    public void llenarTipoComunicacion() {
    ...
    private void buscarDatosSinFechas() {
        ...
        if (!tipoCombo.getSelectedItem().equals("Todos")) {
            sql += " where tipoComunicacion ='" + tipoCombo.getSelectedItem().toString() + "'";
        }
